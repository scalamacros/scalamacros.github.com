...
\begin{frame}
  \titlepage
  This talk is superseded by the presentation delivered at ScalaDays 2014. Links to slides/video of the ScalaDays talk live at \text{\color{blue}\href{http://scalameta.org/}{scalameta.org}}.
\end{frame}
}
