...
Здравствуйте! Меня зовут Евгений Бурмако, с прошлой осени я работаю в Scala Team и параллельно учусь в аспирантуре EPFL на кафедре Мартина Одерского.
...
\begin{frame}[t,fragile]
\frametitle{Макрос для регулярных выражений}
