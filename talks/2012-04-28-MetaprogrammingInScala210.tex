...
\text{\color{linkblue}\href{http://www.scala-lang.org/api/milestone/index.html\#scala.reflect.api.Trees}{docs}}
and in \text{\color{linkblue}\href{https://github.com/scala/scala/blob/master/src/reflect/scala/reflect/api/Trees.scala}{sources}}.
...
\text{\color{linkblue}\href{http://www.scala-lang.org/api/milestone/index.html\#scala.reflect.api.Symbols}{somewhere nearby}}.
...
(also see \text{\color{linkblue}\href{http://www.scala-lang.org/api/milestone/index.html\#scala.reflect.api.Types}{docs}}).
