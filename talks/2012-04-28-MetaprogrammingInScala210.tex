...
\text{\color{linkblue}\href{http://www.scala-lang.org/api/rc/index.html\#scala.reflect.api.Trees}{docs}}
...
\text{\color{linkblue}\href{http://www.scala-lang.org/api/rc/index.html\#scala.reflect.api.Symbols}{somewhere nearby}}.
...
(also see \text{\color{linkblue}\href{http://www.scala-lang.org/api/rc/index.html\#scala.reflect.api.Types}{docs}}).
...
interface, e.g. scala.reflect.runtime.currentMirror, then cm.reflect and then you can get/set fields, invoke methods, etc. Read up more in \text{\color{linkblue}\href{http://www.scala-lang.org/api/rc/index.html\#scala.reflect.api.Mirrors}{our docs}}.
...
This thing is quite involved for a single slide.\\ Check out our reflection guide: \text{\color{linkblue}\href{http://www.scala-lang.org/api/rc/index.html\#scala.reflect.api.Symbols}{analysis}}, \text{\color{linkblue}\href{http://www.scala-lang.org/api/rc/index.html\#scala.reflect.api.Mirrors}{invocation}}.
\end{frame}
